...
input_dir="human_protein_data_files"

# Directory to save the output files
output_dir="human_protein_ph_files"
...
do
    ...
    python ph_functions.py ${input_file} ${output_file} --diagrams_png ${diagrams_png} --landscape_png ${landscape_png}
